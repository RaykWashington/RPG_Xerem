...
local function constructNew_frmArmadura()
    ...
    obj.edit2.grid.width = 4;
    obj.edit2:setField("$(armadura)Res");
    ...
    obj.edit3.grid.width = 4;
    obj.edit3:setField("$(armadura)Esp");
