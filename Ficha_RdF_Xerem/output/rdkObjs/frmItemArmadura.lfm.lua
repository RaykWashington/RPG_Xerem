...
local function constructNew_frmItemArmadura()
    ...
    obj.edit2:setField("desc_$(nomeArmd)");
    ...
    obj.rectangle1:setXradius(7);
    obj.rectangle1:setYradius(7);
    ...
    obj.edit3:setField("VEL_$(nomeArmd)");
    ...
    obj.rectangle2:setXradius(7);
    obj.rectangle2:setYradius(7);
    ...
    obj.edit4:setField("DEF_$(nomeArmd)");
    ...
    obj.rectangle3:setXradius(7);
    obj.rectangle3:setYradius(7);
    ...
    obj.edit5:setField("ARM_$(nomeArmd)");
...
function newfrmItemArmadura()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmItemArmadura();
      end,
      function()
...
local _frmItemArmadura = {
    newEditor = newfrmItemArmadura, 
    new = newfrmItemArmadura, 
    name = "frmItemArmadura", 
    dataType = "", 
    formType = "undefined", 
...
frmItemArmadura = _frmItemArmadura;
Firecast.registrarForm(_frmItemArmadura);

return _frmItemArmadura;
